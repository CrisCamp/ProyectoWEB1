<?php include("template/header.php");?>
        <section class="py-5">
            <div class="container px-5">
                <h2 class="fw-bolder fs-5 mb-4">Carreras y lo que deberias saber</h2>
                <div class="row gx-5">
                                ...
                                <div class="d-flex align-items-end justify-content-between">
                                    <div class="d-flex align-items-center">
                                        <div class="small">
                                            ...
                                            <div class="text-muted">Opotunidades laborales: &middot; <?php echo $registros['oportunidades'] ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
